...
<head>
  ...
  <meta name="description"
    content="@yield('description', 'Réservez votre location sur Morgates')">
  <meta name="author" content="Morgates">
  <meta name="keywords"
    content="@yield('keywords', 'location, bateau, maison')">
  ...
  <meta property="og:description"
    content="@yield('og_description', 'Morgates - réservation & location')">
  ...
  <meta name="twitter:description"
    content="@yield('twitter_description', 'Morgates - réservation & location')">
